    ...
    <main class="container">
        ...
        <div class="emergency-banner">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h3 class="khmer-title"><i class="bi bi-exclamation-triangle-fill me-2"></i> សំណួរបន្ទាន់ ឬបញ្ហាសំខាន់?</h3>
                    <p class="mb-0">ប្រសិនបើអ្នកមានបញ្ហាបន្ទាន់ ឬទំនិញបាត់ដែលមានតម្លៃខ្ពស់ សូមទាក់ទងយើងភ្លាមៗ។</p>
                </div>
                <div class="col-md-4 text-md-end mt-3 mt-md-0">
                    <a href="tel:+85512345678" class="btn btn-light btn-lg" @click="confirmPhoneCall">
