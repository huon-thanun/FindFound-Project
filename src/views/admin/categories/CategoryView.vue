    ...
    <div class="p-3">
        ...
        <div class="banner-container">
          ...
          <div class="banner-text">
            ...
            <h2 class="fw-bold">
              ប្រភេទការបង្ហោះ
              <span class="badge-admin"><i class="bi bi-tag"
            ...
            <p class="text-muted">
              ...
              បង្កើត និងគ្រប់គ្រងប្រភេទនៃរបាយការណ៍ផ្សេងៗ
            </p>
        </div>
        <div><BaseButton variant="primary" @click="openCreateModal" icon="plus-circle">
                បង្កើតប្រភេទថ្មី
            </BaseButton></div>
        </div>
