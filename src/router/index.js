...
const router = createRouter({
  ...
  routes: [
    {
      path: '/', component: UserLayout, meta: { requiresAuth: true }, children: [
    ...
    },
    {
      path: '/admin', component: AdminLayout, meta: { requiresAuth: true }, redirect: { name: "admin.dashoard" }, children: [
        ...
        { path: 'categories', name: 'admin.categories', component: CategoryView, meta: { title: 'Categories' } },
        { path: 'reports', name: 'admin.reports', component: ReportView, meta: { title: 'Reports' } },
        { path: 'reports', name: 'admin.reports', component: ReportView, meta: { title: 'Reports' } },
        { path: 'users', name: 'admin.users', component: UserView, meta: { title: 'Users' } },
        { path: 'login', name: 'admin.login', component: LoignView, meta: { title: 'Login' } },
        { path: 'OTP', name: 'admin.OTP', component: VerifyOTPView, meta: { title: 'OTP' } },
        { path: 'forgotPassword', name: 'admin.forgotPassword', component: ForgotpasswordView, meta: { title: 'Forgot-Password' } },
      ]
    },
    {
      path: "/:pathMatch(.*)*",
